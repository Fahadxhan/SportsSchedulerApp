...
import { Building, User, Mail, Lock, Phone, MapPin, Eye, EyeOff } from 'lucide-react-native';
...
export default function VendorRegisterScreen() {
  ...
  const handleRegister = async () => {
    if (!formData.name || !formData.email || !formData.phone || !formData.password || !formData.businessName || !formData.businessAddress) {
    ...
    try {
      ...
      if (success) {
        ...
        Alert.alert('Error', 'Failed to create vendor account');
      }
    } catch (error) {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Register your sports facility with us</Text>
        </View>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.inputContainer}>
            ...
            <View style={styles.inputWrapper}>
              <Building color={colors.textMuted} size={20} />
              <TextInput
                style={styles.input}
